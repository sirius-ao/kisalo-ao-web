...
import {
  ErrorStateMatcher
} from "./chunk-GX6A4NUZ.js";
import {
  DomSanitizer,
  HttpClient
} from "./chunk-L2KPZXGO.js";
import {
  ControlContainer
} from "./chunk-AIDXA6VB.js";
import {
  MatRipple,
  MatRippleModule,
  _StructuralStylesLoader
} from "./chunk-BYEQAHMI.js";
import {
  ENTER,
  FocusKeyManager,
  FocusMonitor,
  ...
  hasModifierKey
} from "./chunk-EVHIUMGF.js";
import {
  Platform,
  _CdkPrivateStyleLoader
} from "./chunk-EB373QUU.js";
import {
  BidiModule,
  Directionality
} from "./chunk-YXJXK2M2.js";
import {
  NgTemplateOutlet
} from "./chunk-BDKMSZXY.js";
import {
  ...
  ɵɵtextInterpolate,
  ɵɵviewQuery
} from "./chunk-56OE5JIV.js";
import {
  __toESM
} from "./chunk-R3KN4MOR.js";
...
var MatIconRegistry = class _MatIconRegistry {
  ...
  getSvgIconFromUrl(safeUrl) {
    ...
    if (cachedIcon) {
      return (0, import_rxjs2.of)(cloneSvg(cachedIcon));
    }
    return this._loadSvgIconFromConfig(new SvgIconConfig(safeUrl, null)).pipe((0, import_operators2.tap)((svg) => this._cachedIconsByUrl.set(url, svg)), (0, import_operators2.map)((svg) => cloneSvg(svg)));
  }
  /**
  ...
  getNamedSvgIcon(name, namespace = "") {
    ...
    return (0, import_rxjs2.throwError)(getMatIconNameNotFoundError(key));
  }
  ngOnDestroy() {
    this._resolvers = [];
  ...
  _getSvgFromConfig(config) {
    if (config.svgText) {
      return (0, import_rxjs2.of)(cloneSvg(this._svgElementFromConfig(config)));
    } else {
      return this._loadSvgIconFromConfig(config).pipe((0, import_operators2.map)((svg) => cloneSvg(svg)));
    }
  }
  /**
  ...
  _getSvgFromIconSetConfigs(name, iconSetConfigs) {
    ...
    if (namedIcon) {
      return (0, import_rxjs2.of)(namedIcon);
    }
    const iconSetFetchRequests = iconSetConfigs.filter((iconSetConfig) => !iconSetConfig.svgText).map((iconSetConfig) => {
      return this._loadSvgIconSetFromConfig(iconSetConfig).pipe((0, import_operators2.catchError)((err) => {
    ...
    return (0, import_rxjs2.forkJoin)(iconSetFetchRequests).pipe((0, import_operators2.map)(() => {
  ...
  _loadSvgIconFromConfig(config) {
    return this._fetchIcon(config).pipe((0, import_operators2.tap)((svgText) => config.svgText = svgText), (0, import_operators2.map)(() => this._svgElementFromConfig(config)));
  }
  /**
  ...
  _loadSvgIconSetFromConfig(config) {
    ...
    return this._fetchIcon(config).pipe((0, import_operators2.tap)((svgText) => config.svgText = svgText));
  }
  /**
  ...
  _fetchIcon(iconConfig) {
    ...
    const req = this._httpClient.get(url, {
      responseType: "text",
      withCredentials
    }).pipe((0, import_operators2.map)((svg) => {
      return trustedHTMLFromString(svg);
    }), (0, import_operators2.finalize)(() => this._inProgressUrlFetches.delete(url)), (0, import_operators2.share)());
...
var MatIcon = class _MatIcon {
  ...
  _currentIconFetch = import_rxjs3.Subscription.EMPTY;
  constructor() {
  ...
  _updateSvgIcon(rawName) {
    ...
    if (rawName) {
      ...
      this._currentIconFetch = this._iconRegistry.getNamedSvgIcon(iconName, namespace).pipe((0, import_operators3.take)(1)).subscribe((svg) => this._setSvgElement(svg), (err) => {
...
var MatStep = class _MatStep extends CdkStep {
  ...
  _viewContainerRef = inject(ViewContainerRef);
  _isSelected = import_rxjs4.Subscription.EMPTY;
  ...
  _portal;
  ngAfterContentInit() {
    this._isSelected = this._stepper.steps.changes.pipe((0, import_operators4.switchMap)(() => {
      return this._stepper.selectionChange.pipe((0, import_operators4.map)((event) => event.selectedStep === this), (0, import_operators4.startWith)(this._stepper.selected === this));
...
var MatStepper = class _MatStepper extends CdkStepper {
  ...
  ngAfterContentInit() {
    ...
    this.steps.changes.pipe((0, import_operators4.takeUntil)(this._destroyed)).subscribe(() => this._stateChanged());
    this.selectedIndexChange.pipe((0, import_operators4.takeUntil)(this._destroyed)).subscribe(() => {
  ...
  ngAfterViewInit() {
    ...
    if (typeof queueMicrotask === "function") {
      ...
      this._animatedContainers.changes.pipe((0, import_operators4.startWith)(null), (0, import_operators4.takeUntil)(this._destroyed)).subscribe(() => queueMicrotask(() => {
